...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    app.send_message(message.chat.id, f"__👋 Hi **{message.from_user.mention}**, I am Link Bypasser Bot hosted by 𝙏𝙚𝙖𝙢 𝙎𝙋𝙔, just send me any supported links and i will you get you results.\nCheckout /help to Read More__",
    reply_markup=InlineKeyboardMarkup([
        [ InlineKeyboardButton("🌐 𝙅𝙤𝙞𝙣 𝙎𝙪𝙥𝙥𝙤𝙧𝙩 𝘾𝙝𝙖𝙣𝙣𝙚𝙡", url="https://t.me/spy_adda_official")],
        [ InlineKeyboardButton("𝙊𝙬𝙣𝙚𝙧", url="https://t.me/gazabho") ]]), 
